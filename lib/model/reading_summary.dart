...
//
//     final readingSummary = readingSummaryFromJson(jsonString);

import 'dart:convert';

List<ReadingSummary> readingSummaryFromJson(String str) => List<ReadingSummary>.from(json.decode(str).map((x) => ReadingSummary.fromJson(x)));

String readingSummaryToJson(List<ReadingSummary> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
